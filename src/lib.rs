...
pub const CURRENT_BLOCK_HEIGHT: u64 = 951239;
...
pub fn calculate_sats(btc: f64) -> u64 {
    ...
    let sats_f64 = btc * BTC_TO_SATS as f64;
    sats_f64 as u64
}
...
pub fn validate_block_height(height: i64) -> (bool, String) {
    ...
    match height {
        h if h < 0 => (false, "Block height cannot be negative".to_string()),
        h if h > 1_000_000 => (false, "Block height at unrealistic value".to_string()),
